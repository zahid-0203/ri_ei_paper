...
\begin{document}
	...
	We introduce the Localization Mask Overlap Score (LMOS), used in both ETI and ERI,  to quantify object-focused explanation quality. 
	...
	It is observed that in Grad-CAM visualizations, red and yellow regions in images are activated most i.e., red and yellow have greater influence than other colors on models' predictions \cite{r14,r15}. 

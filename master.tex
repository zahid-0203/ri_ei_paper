...
\scriptsize Apple % Original image
\end{tabular}
&
\begin{tabular}[c]{c}
...
\centering
\renewcommand{\arraystretch}{1.5}
\caption{Grad-CAM visualization on BDML}
\label{tab:model_robustness}
